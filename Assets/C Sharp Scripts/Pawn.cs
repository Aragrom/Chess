...
public class Pawn : Piece
{
    ...
    public Piece.Type promotionType = Piece.Type.Pawn;
    ...
    public void Promote(Piece.Type type)
    {
        isPromoted = true;
        promotionType = type;
        SetSprite();
    ...
    {
        if (isWhite)    // For White Piece
        {
            switch (promotionType)
            {
                case Piece.Type.Pawn:
                    spriteRenderer.sprite = game.whitePawnSprite;
                    break;

                case Piece.Type.Rook:
                    spriteRenderer.sprite = game.whiteRookSprite;
                    break;

                case Piece.Type.Bishop:
                    spriteRenderer.sprite = game.whiteBishopSprite;
                    break;

                case Piece.Type.Knight:
                    spriteRenderer.sprite = game.whiteKnightSprite;
                    break;

                case Piece.Type.Queen:
                    spriteRenderer.sprite = game.whiteQueenSprite;
                    break;
            }
        }
        else    // For Black Piece
        {
            ...
            {
		        case Piece.Type.Pawn:
                    spriteRenderer.sprite = game.blackPawnSprite;
                    break;

                case Piece.Type.Rook:
                    spriteRenderer.sprite = game.blackRookSprite;
                    break;

                case Piece.Type.Bishop:
                    spriteRenderer.sprite = game.blackBishopSprite;
                    break;

                case Piece.Type.Knight:
                    spriteRenderer.sprite = game.blackKingSprite;
                    break;

                case Piece.Type.Queen:
                    spriteRenderer.sprite = game.blackQueenSprite;
                    break; 
            }
        }
    }
    ...
    public new void GetMoves()
    {
        switch (promotionType)
        {
            ...
            case Piece.Type.King:
                ...
                Debug.Log("Pawn.GetMoves() - Pawn can NOT be a king!");
                break;
        }
    }
    ...
    {
        Debug.Log("Pawn.HasMove() - Ran inherited class function");
    ...
    {
        Debug.Log("Pawn.Move() - Pawn = " + this.transform.name + " Index = " + index.ToString() + " Developed = " + developed);
        ...
        {
            game.main.userInterface.promotablePawn = this;
        }
    }
    ...
    public bool EnPassantAttack(int index)
    {
        for (int i = 0; i < enPassantAttacks.Length; i++)
        {
            if (enPassantAttacks[i] == index)
            {
                ...
                board.squares[enPassantActualPosition].piece.gameObject.SetActive(false);
    ...
    public bool IsEnPassantAttackLegal(int index)
    {
        ...
        Pawn attackedPawn = (Pawn)board.squares[enPassantActualPosition].piece;
        ...
        attackedPawn.gameObject.SetActive(false);
        ...
        attackedPawn.gameObject.SetActive(true);
