...
public class Rook : Piece
{
    ...
    {
        Debug.Log("Rook.Move() - Pawn = " + this.transform.name + " Index = " + index.ToString());
        ...
        List<int> tempDiscoverableDefending)
    {
        ...
        while (board.IsMoveInScope(tempIndex))
        {
            column = AdjustColumn(step, column);
    ...
    public int AdjustRow(int moveType, int row)
    {
        switch (moveType)
        {
    ...
    public int AdjustColumn(int moveType, int column)
    {
        switch (moveType)
        {
